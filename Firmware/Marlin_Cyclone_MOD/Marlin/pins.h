...
#define TEMP_1_PIN         -1
#define TEMP_2_PIN         -1
#define TEMP_BED_PIN        6   // MUST USE ANALOG INPUT NUMBERING NOT DIGITAL OUTPUT NUMBERING!!!!!!!!! (pin 34 -D25- bed)
#define SDPOWER            -1
#define SDSS               31
...
#define _E0_PINS E0_STEP_PIN, E0_DIR_PIN, E0_ENABLE_PIN, HEATER_0_PIN, 
  ...
  #define _E2_PINS
    ...
    #define Z_MAX_PIN -1
  #else
    #define Z_MIN_PIN Z_PROBE_PIN //-1 // CGS MOD: Added the Z_MIN_PIN

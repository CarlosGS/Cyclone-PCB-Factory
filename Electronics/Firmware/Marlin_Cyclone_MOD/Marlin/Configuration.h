...
#define ENDSTOPPULLUPS // Comment this out (using // at the start of the line) to disable the endstop pullup resistors
  ...
  #define ENDSTOPPULLUP_XMIN
  #define ENDSTOPPULLUP_YMIN
  #define ENDSTOPPULLUP_ZMIN // CGS MOD: Our probe does work with a pullup (internal), just as the other endstops
#endif
...
#define X_HOME_DIR -1
#define Y_HOME_DIR -1
#define Z_HOME_DIR 1 //CGS MOD: IMPORTANT: Our machine will have the Z endstop on top (Z axis will "home up")
                     //                    We will have a "z probe" as the Z lower endstop
...
#define HOMING_FEEDRATE {4*60, 4*60, 2*60, 0}  // set the homing speeds (mm/min)
